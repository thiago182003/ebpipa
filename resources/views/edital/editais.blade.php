...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-0"><span class="text-muted fw-light">    Cadastro /</span> Edital
        </h4>
        <div class="row">
            <div class="col-md-12">
            ...
            <div class="col-md-12">
                <div class="card mb-3">
                                    ...
                                    <table id="tb-analise" class="table table-sm table-striped table-bordered">
                                        ...
                                        <tbody>
                                            @foreach ($editais as $edital)
                                                <tr>
                                                    <td>{{ @$edital->nome }}</td>
                                                    <td>{{ @$edital->om->sigla }}</td>
                                                    <td>
                                                        <a href="{{ route('edital.editar', @$edital->id) }}"
                                                            class="btn btn-sm btn-icon btn-outline-primary">
                                                            <span class="tf-icons bx bx-edit"></span>
                                                        </a>
                                                    </td>
                                                    <td>
                                                        <button data-id={{@$edital->id}} data-nome="{{@$edital->nome}}" class="btn btn-sm btn-icon btn-outline-danger remover">
                                                            <i class='bx bx-x'></i>
                                                        </button>
                                                    </td>
                                                </tr>
                    ...
                    <div class="mt-2 save-now">
                        <a href="{{ route('edital.novo')}}" type="submit" class="btn btn-success btn-novo-now"><i class='bx bx-plus'></i>
                            Novo</a>
                    </div>
                </div>
            </div>
