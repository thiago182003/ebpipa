...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Empresa /</span> Adicionar Motorista</h4>
                                ...
                                <div class="mb-2 col-md-6">
                                    ...
                                    <select @required(true) id="municipio" name='municipio'
                                        ...
                                        @foreach ($municipios as $municipio)
                                            <option {{ $municipio->id == @$credenciamento->id_municipio ? 'selected' : '' }}
                                ...
                                <div class="mb-2 col-md-12">
                                    <table class="table table-sm table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <label class="form-label" for="comprovanteresidencia">Comprovante
                                                        de residência</label>
                                                </td>
                                                <td>
                                ...
                                <div class="mb-2 col-md-12">
                                    <table class="table table-sm table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <label class="form-label" for="doc_crlv">
                                                        <span data-bs-toggle='tooltip' data-bs-offset='0,4'
                                                            data-bs-placement='right' data-bs-html='true'
                                                            data-bs-original-title="Deverá constar, nos campos CATEGORIA e CARROCERIA, as modalidades “aluguel” e “tanque” respectivamente.">Certificado
                                                            de Registro e
                                                            Licenciamento
                                                            Veicular (CRLV)
                                                            <i class='bx bx-info-circle' style="color: #ff3e1d"></i>
                                            ...
                                            <tr>
                                                <td>
                                                    <label class="form-label" for="veiculo_img">
                                                        <span data-bs-toggle='tooltip' data-bs-offset='0,4'
                                                            data-bs-placement='right' data-bs-html='true'
                                ...
                                <div class="mb-2 col-md-12">
                                    <div class="table-responsive text-nowrap">
                                        <table class="table table-sm table-bordered table-striped">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><strong>01. Requerimento de Credenciamento (Anexo C)</strong>
                                                    </td>
                                                ...
                                                {{-- <tr>
                                                    <td><strong>02. Declaração de Conhecimento das Informações para
                                                            Cumprimento
                                                ...
                                                <tr>
                                                    <td><strong>03. Termo de Declaração e Responsabilidade das condições
                                                            de
                                                            trafegabilidade do Veículo a ser credenciado (Anexo
                                                            F)</strong>
                                                    </td>
                                                ...
                                                {{-- <tr>
                                                    <td><strong>04. Modelo de autorização para exposição de dados (Anexo
                                                            H)</strong></td>
                                                ...
                                                <tr>
                                                    <td><strong>05. Comprovante de Inscrição como Contribuinte
                                                            Individual da
                                                ...
                                                {{-- <tr>
                                                    <td><strong>06. Certidão de Quitação Eleitoral</strong></td>
                                                    <td><a target="_blank"
                                                ...
                                                {{-- <tr>
                                                    <td><strong>07. Certidão de Quitação com o Serviço Militar (para o
                                                            sexo
                                                            masculino)</strong></td>
                                                    <td><a target="_blank"
                                                ...
                                                {{-- <tr>
                                                    <td><strong>08. Certificado de Registro no Sistema de Cadastramento
                                                ...
                                                {{-- <tr>
                                                    <td><strong>09. Comprovante de Inscrição e Situação Cadastral no
                                                            CPF</strong></td>
                                                    <td><a target="_blank"
                                                ...
                                                {{-- <tr>
                                                    <td><strong>10. Certidão Negativa de Débitos Federais</strong></td>
                                                    <td><a target="_blank"
                                                ...
                                                {{-- <tr>
                                                    <td><strong>11. Certidão Negativa de Débitos Estaduais</strong></td>
                                                    <td>
                                                    </td>
                                                    <td><input class="form-control form-control-sm" type="file"
                                                ...
                                                {{-- <tr>
                                                    <td><strong>12. Certidão Negativa de Débitos Municipais</strong>
                                                    </td>
                                                    <td></td>
                                                    <td><input class="form-control form-control-sm" type="file"
                                                ...
                                                {{-- <tr>
                                                    <td><strong>13. Certidão de Inexistência de Débitos
                                                            Trabalhistas</strong>
                                                    </td>
                                                    <td><a target="_blank"
                                                    ...
                                                    <td>
                                                        <strong>
                                                            ...
                                                            <span data-bs-toggle='tooltip' data-bs-offset='0,4'
                                                                ...
                                                                GVISA/AL.">
                                                                15. Laudo da Vigilância Sanitária
                                                                <i class='bx bx-info-circle' style="color: #ff3e1d"></i>
                                                            </span>
                                                        </strong>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <strong>
                                                            ...
                                                            <span data-bs-toggle='tooltip' data-bs-offset='0,4'
                                                                data-bs-placement='right' data-bs-html='true'
                                                                data-bs-original-title="Em caso do interessado não ser o proprietário do caminhão, deverá ser apresentado contrato de locação do veículo, a depender da relação jurídica que exista entre as partes, registrado em cartório entre o proprietário e possuidor temporário do veículo.<br>O prazo de vigência do contrato de locação do veículo deverá ser no mínimo entre a data do Requerimento de Credenciamento (Anexo C) até o dia 31 de dezembro de 2024.">
                                                                17. Contrato de Locação
                                                                <i class='bx bx-info-circle' style="color: #ff3e1d"></i>
                                                            </span>
                                                        </strong>
                                                    </td>
