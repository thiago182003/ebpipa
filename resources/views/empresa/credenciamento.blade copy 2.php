                ...
                <div class="col-md-12">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="mb-2 col-md-12">
                                    ...
                                    <ul>
                                        <li>
                                            <p>O(a) interessado(a) que preencher os requisitos exigidos neste Edital, no
                                                que a ele(a) for aplicável, será considerado(a) habilitado(a), mas o
                                        ...
                                        <li>
                                            <p>É de extrema importância o preenchimento de todos os campos,
                                                ...
                                                informações referente as etapas do Credenciamento, como também
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="mb-2 col-md-3">
                                    <label for="cnpj" class="form-label">CNPJ<i style="color: #ff3e1d">*</i></label>
                                    <input class="form-control form-control-sm" disabled type="text" name="cnpj"
                                        id="cnpj" value="{{ $empresa->cnpj }}" />
                                </div>
                                <div class="mb-2 col-md-6">
                                    <label for="firstName" class="form-label">Razão Social<i
                                            style="color: #ff3e1d">*</i></label>
                                ...
                                <div class="mb-2 col-md-3">
                                    <label for="email" class="form-label">E-mail<i style="color: #ff3e1d">*</i></label>
                                ...
                                <div class="mb-2 col-md-3">
                                    <label class="form-label" for="phoneNumber">Telefone/Whatsapp<i
                                            style="color: #ff3e1d">*</i></label>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="mb-2 col-md-6">
                                    <label for="cep" class="form-label">Nome<i style="color: #ff3e1d">*</i></label>
                                ...
                                <div class="mb-2 col-md-3">
                                    <label for="telefone_representante" @required(true) class="form-label">Telefone<i
                                            style="color: #ff3e1d">*</i></label>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="mb-2 col-md-3">
                                    <label for="banco" class="form-label">Banco<i style="color: #ff3e1d">*</i></label>
                                ...
                                <div class="mb-2 col-md-3">
                                    <label for="agencia" class="form-label">Agencia<i
                                            style="color: #ff3e1d">*</i></label>
                                    <input class="form-control form-control-sm" required type="text" id="agencia"
                                        name="agencia" value="{{ @$dadosbancarios->agencia }}" />
                                </div>
                                <div class="mb-2 col-md-3">
                                    <label for="conta" class="form-label">Conta<i style="color: #ff3e1d">*</i></label>
                                            ...
                                            <tbody>
                                                {{-- <tr>
                                                    ...
                                                    @if (@$credenciamento->doc_reqcred)
                                                        ...
                                                        <td>
                                                            <button class="btn btn-sm btn-outline-danger remover"
                                                                data-tipo="empresa" data-arquivo="doc_reqcred"
                                                                data-nome="Documentação do Representante"><i
                                                                    class='bx bx-x'></i>
                                                            </button>
                                                        </td>
                                                    @else
                                                ...
                                                <tr>
                                                    ...
                                                    <td></td>
                                                    <td><input class="form-control form-control-sm" type="file"
                                                            accept="application/pdf" id="doc_emp_tdm" name="doc_emp_tdm"
                                                            value="" />
                                                    </td>
                                                ...
                                                <tr>
                                                    <td><strong>4. Certificado de Condição de Microempreendedor Individual -
                                                            MEI</strong></td>
                                                    <td></td>
                                                    <td><input class="form-control form-control-sm" type="file"
                                                ...
                                                <tr>
                                                    <td><strong>15. Alvará de licença de funcionamento</strong></td>
                                                    <td></td>
                                                    <td><input class="form-control form-control-sm" type="file"
                                                            accept="application/pdf" id="doc_emp_alf" name="doc_emp_alf"
                                                            value="" />
                                                    </td>
                                                ...
                                                <tr>
                                                    <td><strong>16. Atestado de Capacidade Técnica</strong></td>
                                                    <td></td>
                                                    <td><input class="form-control form-control-sm" type="file"
                                                            accept="application/pdf" id="doc_act" name="doc_act"
                                                            value="" />
