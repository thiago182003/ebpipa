...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Administração /</span> Meu Perfil</h4>

        <div class="row">
            <div class="col-md-12">
                @include('componentes.mensagem')
                <form id="formAccountSettings" method="post" action="{{ route('empresa.salvar') }}">
                    @csrf
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-start align-items-sm-center gap-4">
                                ...
                                <div class="button-wrapper">
                                    <label for="imagem_empresa" class="btn btn-primary me-2 mb-4" tabindex="0">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text" id="telefone" name="telefone" class="form-control"
                                            placeholder="(xx) xxxx-xxxxx" value="{{ $empresa->telefone }}" />
                                    </div>
                                </div>
                                {{-- <div class="mb-3 col-md-6">
                  ...
                  <div class="input-group input-group-merge">
                    ...
                    <option value="">Selecione...</option>
                                ...
                                <div class="mb-3 col-md-6">
                                    <label class="form-label" for="residencia">Comprovante de residência</label>
                                    <input class="form-control" type="file" id="residencia" name="residencia"
                                        value="" />
                                </div>
                            </div>
                        </div>
