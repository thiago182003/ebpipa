            ...
            <div class="col-md-12">
                <div class="card mb-3">
                                        ...
                                        <tbody>
                                            @foreach ($oms as $om)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ @$om->sigla }}</td>
                                                    <td>
                                                        <a href="{{ route('om.editar', @$om->id) }}"
                                                            class="btn btn-sm btn-icon btn-outline-primary">
                                                            <span class="tf-icons bx bx-edit"></span>
                                                        </a>
                                                    </td>
                                                    <td>
                                                        <button data-id={{@$om->id}} data-nome="{{@$om->nome}}" class="btn btn-sm btn-icon btn-outline-danger remover">
                                                            <i class='bx bx-x'></i>
                                                        </button>
                                                    </td>
                                                </tr>
                    ...
                    <div class="mt-2 save-now">
                        <a href="{{ route('om.novo')}}" type="submit" class="btn btn-success btn-novo-now"><i class='bx bx-plus'></i>
                            Novo</a>
                    </div>
                </div>
            </div>
