...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <form id="formAccountSettings" method="post" enctype="multipart/form-data" action="{{ route('pipeiro.credenciar') }}">
            <div class="row">
                <div class="col-md-12">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-start align-items-sm-center gap-4">
                                ...
                                <div class="button-wrapper">
                                    <label for="imagem_pipeiro" class="btn btn-sm btn-primary me-2 mb-4" tabindex="0">
                                ...
                                <div class="mb-2 col-md-12">
                                    <div class="table-responsive text-nowrap">
                                        <table class="table table-sm table-bordered table-striped">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><strong>01. Requerimento de Credenciamento (Anexo C)</strong></td>
                                                    <td><a href="/docs/modelo_anexo_c.doc" target="_blank">baixar</a></td>
                                                    <td>
                                                        <input class="form-control form-control-sm" type="file"
                                                ...
                                                <tr>
                                                    <td><strong>03. Termo de Declaração e Responsabilidade das condições de
                                                ...
                                                <tr>
                                                    <td><strong>05. Comprovante de Inscrição como Contribuinte Individual da
                                                ...
                                                <tr>
                                                    <td><strong>07. Certidão de Quitação com o Serviço Militar (para o sexo
                                                            masculino)</strong></td>
                                                    <td><a target="_blank"
                                                ...
                                                <tr>
                                                    <td><strong>12. Certidão Negativa de Débitos Municipais</strong></td>
                                                    <td></td>
                                                    <td><input class="form-control form-control-sm" type="file"
                                                ...
                                                <tr>
                                                    <td><strong>15. Laudo da Vigilância Sanitária</strong></td>
                                                    <td></td>
                                                    <td><input class="form-control form-control-sm" type="file"
                                                ...
                                                {{-- <tr>
                                                    <td><strong>16. Atestado de Capacidade Técnica (Só Pessoa Jurídica)</strong></td>
                                                    <td></td>
                                                    <td><input class="form-control form-control-sm" type="file"
                                                ...
                                                <tr>
                                                    <td><strong>17. Contrato de Locação</strong></td>
                                                    <td></td>
                                                    <td><input class="form-control form-control-sm" type="file"
