...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-0"><span class="text-muted fw-light">    Cadastro /</span> Credenciamentos </h4>
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-3">
                    <div class="card-body">
                                        ...
                                        <tbody>
                                            @foreach ($creds as $c)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('pipeiro.credenciamento', ['id'=>$c->id]) }}"
                                                            class="btn btn-sm btn-icon btn-outline-primary">
                                                            <span class="tf-icons bx bx-edit"></span>
                                                        </a>
                                                    </td>
                                                    <td>
                                                        <button data-status="{{$c->status}}" data-id="{{$c->id}}" data-nome="{{$c->edital->nome}}" 
                    ...
                    <div class="mt-2 save-now">
                        <a href="{{ route('pipeiro.novocredenciamento')}}" type="submit" class="btn btn-success btn-novo-now"><i class='bx bx-plus'></i>
                            Novo</a>
                    </div>
                </div>
            </div>
            ...
            <script>
                ...
                $(".enviar").on("click", function(e) {
                    ...
                    if (confirm('Deseja enviar o credenciamento para análise?')) {
                        ...
                        $.post('/pipeiro/enviarcredenciamento', { id: id })
