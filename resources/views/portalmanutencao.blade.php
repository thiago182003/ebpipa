...
<body>
    <div class="container">
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page"
                                href="https://7rm.eb.mil.br/index.php/programas/765-propipa">Editais</a>
                        </li>
                        {{-- <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a type="button" class="btn rounded-pill btn-pipa"
                                href="{{ route('login.cadastro') }}">Cadastrar</a>
                        </li> --}}
                    </ul>
        ...
        <div class="row mt-3">
            <img src="/img/fundo.jpg" />asdasdas
            <center>
                <h1 style="color: #ef2b0d"><i class='bx bx-error'></i>Estamos passando por uma manutenção<i
                        class='bx bx-error'></i> </h1>
            </center>
        </div>
